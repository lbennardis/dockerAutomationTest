...
RUN bash -c 'touch /temp/mvn-repo/01_spring_boot_rest_backing_services/01_spring_boot_rest_backing_services/1.2.1.RELEASE/01_spring_boot_rest_backing_services-1.2.1.RELEASE.jar'
